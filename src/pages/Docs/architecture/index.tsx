...
export const ArchitectureMainPage = () => {
    return (
        <>
            <h2 id='architecture'><div className='title'><div className='tag'>/</div>Architecture</div></h2>
            <br />
            ...
            <br /><br/>
            <h2 id='in-general-terms'><div className='title middle'><div className='tag'>#</div>In general terms</div></h2>
            <br />
            ...
            <br /><br />
            <h2 id='working-with-the-database'><div className='title middle'><div className='tag'>#</div>Working with the database</div></h2>
            <br />
            ...
            <br /><br />
            <h2 id='flow'><div className='title middle'><div className='tag'>#</div>Flow</div></h2>
