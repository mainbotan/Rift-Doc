...
import { ContractMethodsTable } from '../sources/methods-table';
...
export const BasicConceptsContractMethodsPage = () => {
    return (
        <>
            ...
            <br />
            So, having got acquainted with the <div className='code-tag'>ResultType</div> object and ways to initialize it, let's look at methods for creating logical chains based on it. 
            <br /><br />
            ...
            <br /><br /><br />
            <div className='title middle'><div className='tag'>#</div>Basic methods</div>
            <ContractMethodsTable />
            <br />
            <div className='title middle'><div className='tag'>#</div>Chain processing</div><br />
            Most of the methods <div className='code-tag'>ResultType</div> depend on the result of checking the object for success/failure using the basic method <div className='code-tag'>isSuccess</div>.
