...
export const DatabasesRepositoriesPage = () => {
    ...
    return (
        <>
            ...
            making up the <div className='code-tag'>$stmt</div> you need, executing the request and returning the <div className='code-tag'>ResponseDTO</div> with the result of the request.
            <br /><br />
