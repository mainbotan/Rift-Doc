...
export const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'architecture/databases/pdo', element: <DatabasesPDOPage /> },
      { path: 'architecture/databases/models', element: <DatabasesModelsPage /> },
      { path: 'architecture/databases/repositories', element: <DatabasesRepositoriesPage /> },
