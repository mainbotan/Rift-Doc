export const ValidatorShortDescription = (
   ...
   The validator provided by the Rift core can make your life much easier. 
    ...
    <br /><br />
    Rift Validator is divided into utilities that are responsible for their data type and is equipped with a SchemaValidator that combines all utilities (which you can use separately, of course) and allows you to validate input data according to a predefined scheme. Nested schemas, enum fields, custom error messages, and validation functions - Rift Validator already knows how to do all this. 
